...
def build_graph(reader,
  ...
  tower_num_frames = tf.split(num_frames_ph, num_towers)
  tower_gradients = []
  tower_predictions = []
  tower_label_losses = []
  tower_reg_losses = []
  ...
  tf.add_to_collection("model_input_raw_ph", model_input_raw_ph)
  tf.add_to_collection("num_frames_ph", num_frames_ph)
      ...
      try:
        ...
        while (not sv.should_stop()) and (not self.max_steps_reached):
          ...
          _, global_step_val, loss_val, predictions_val, labels_val = sess.run(
              [train_op, global_step, loss, predictions, labels], feed_dict={model_input_raw_ph:pr_feature, num_frames_ph: pr_num})
